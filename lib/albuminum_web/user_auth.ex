defmodule AlbuminumWeb.UserAuth do
  ...
  Use in live_session: `on_mount: [{AlbuminumWeb.UserAuth, :require_authenticated_user}]`
  """
  ...
  @remember_me_cookie "_albuminum_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AlbuminumWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
