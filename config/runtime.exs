...
#
#     PHX_SERVER=true bin/albuminum start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :albuminum, AlbuminumWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/albuminum/albuminum.db
      """

  config :albuminum, Albuminum.Repo,
  ...
  config :albuminum, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :albuminum, Albuminum.Mailer,
